...
@Component({
  ...
  export class hydrographSeasonal {
    ...
    hydrograph_Seasonal() {
      ...
      //console.log("tableau Q ", resultArray);
        
      this.fig = {
        data: [],
        layout: {
            title: { text: 'Débits de cours d\'eau [' + this.dischargeStation[1] + ']', font: { size: 16 } },
            ...
            yaxis: { title: 'Débit de cours d\'eau [m3/s]', type: 'log', exponentformat: 'power' },
            annotations: [
